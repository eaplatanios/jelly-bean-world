		...
		float max_steps_per_second)
{
	...
	config.item_types[0].scent[0] = 2.0f * (1.0f - 0.96f);
	config.item_types[0].scent[1] = 2.0f * (1.0f - 0.88f);
	config.item_types[0].scent[2] = 2.0f * (1.0f - 0.20f);
	...
	config.item_types[1].scent[0] = 1.0f - 0.68f;
	config.item_types[1].scent[1] = 1.0f - 0.01f;
	config.item_types[1].scent[2] = 1.0f - 0.99f;
	...
	config.item_types[2].scent[0] = 2.0f * (1.0f - 0.82f);
	config.item_types[2].scent[1] = 2.0f * (1.0f - 0.27f);
	config.item_types[2].scent[2] = 2.0f * (1.0f - 0.20f);
	...
	config.item_types[4].scent[0] = 1.0f - 0.00f;
	config.item_types[4].scent[1] = 1.0f - 0.47f;
	config.item_types[4].scent[2] = 1.0f - 0.06f;
	...
	config.item_types[5].scent[0] = 20.0f * (1.0f - 0.42f);
	config.item_types[5].scent[1] = 20.0f * (1.0f - 0.24f);
	config.item_types[5].scent[2] = 20.0f * (1.0f - 0.13f);
	...
	config.item_types[5].intensity_fn.args[0] = -10.0f;
